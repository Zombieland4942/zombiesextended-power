...
for x, substation in pairs(substations) do
    ...
    sub.icon = "__darkstar-power__/graphics/icons/" .. substation.name .. ".png"
    ...
    sub.pictures.layers[1].filename = "__darkstar-power__/graphics/entity/" .. substation.name .. "/substation.png"
    sub.pictures.layers[1].hr_version.filename = "__darkstar-power__/graphics/entity/" .. substation.name .. "/hr-substation.png"

    item.name = substation.name    
    item.icon = "__darkstar-power__/graphics/icons/" .. substation.name .. ".png"
